  ...
  return (
    ...
    >
      ...
      >
        ...
        <ImageBackground
          source={require("../../assets/images/Moneybar.png")}
          style={{ width: 317, height: 77, marginVertical: 20 }}
        >
          <View style={{ flexDirection: "row", top: 24, left: 75 }}>
            {mainSegments.map((segment, index) => {
              const previousProgress = mainSegments
                .slice(0, index)
      ...
      {categories.map((category, index) => {
        ...
        return (
          <View
            key={index}
            style={{ width: "90%", marginVertical: 0, alignItems: "center" }}
          >
            <TouchableOpacity
          ...
          >
            ...
            >
              <View style={{ left: 30, top: 35 }}>
                ...
                <ImageBackground
                  source={require("../../assets/images/Woodbar.png")}
                  resizeMode="stretch"
                  style={{ width: 130 }}
                >
                  ...
                  >
                    {selectedCategory.segments.map((segment, segIndex) => {
                      const previousProgress = selectedCategory.segments
                        .slice(0, segIndex)
                        .reduce((sum, seg) => sum + seg.progress, 0);
                      return (
                        // <Progress.Bar
                ...
                >
                  {selectedCategory.segments.map((segment, segIndex) => (
                    ...
                    >
                      ...
                      />
                      <Text style={{ fontSize: 12, fontFamily: "red-alert" }}>
                        {segment.name + " - " + segment.progress * 100 + "%"}
                      </Text>
                    </View>
                  ))}
                </View>
